...
export interface StatistiquesRh { categories:Record<string,unknown>[];chargeEnseignants:Record<string,unknown>[];presence:Record<string,unknown>[];evaluations:Record<string,unknown>[]; }
