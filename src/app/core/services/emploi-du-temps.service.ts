...
import { AbsenceCours, AbsencePayload, CoursPayload, CoursPlanifie, DisponibiliteEnseignant, DisponibilitePayload, EmploiDuTempsOptions, Remplacement, RemplacementPayload, StatutPublication, SuggestionConflit } from '../models/emploi-du-temps.models';
